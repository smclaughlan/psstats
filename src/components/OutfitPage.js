  ...
  const getOutfitData = async () => {
    try {
      ...
      if (res.ok) {
        ...
        let convertedMembers = formatMemData(
          unsortedMembers
        );
              ...
              <TableRow>
                ...
                <TableCell>
                  <Button
                    label="Outfit Rank"
                    onClick={() => {
                      sortMembers(members, "outfitrank");
                    }}
                  />
                </TableCell>
                <TableCell>
                  <Button
                    label="Battle Rank"
                    onClick={() => {
                      sortMembers(members, "battlerank");
                    }}
                  />
                </TableCell>
                <TableCell>
